...
class Battery:
    ...
    def upgrade_battery(self):
        if self.battery_size < 100:
            print(f"This is {self.battery_size}-kWh battery model")
            self.battery_size = 100
            print(f"We upgrade it to {self.battery_size}-kWh battery model")
        else:
            print(f"This is already full complectation of the car!")
